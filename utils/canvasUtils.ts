...
export function drawCabinet(
	...
	if (type === 'l_shape') {
		ctx.moveTo(-20.0 * scale, -15 * scale)
		ctx.lineTo(20.0 * scale, -15 * scale)
		ctx.lineTo(20.0 * scale, 0)
		ctx.lineTo(-5.0 * scale, 0)
		ctx.lineTo(-5.0 * scale, 15 * scale)
		ctx.lineTo(-20.0 * scale, 15 * scale)
		ctx.closePath()
	} else if (type === 'l_shape_mirror') {
		ctx.moveTo(20.0 * scale, -15 * scale)
		ctx.lineTo(-20.0 * scale, -15 * scale)
		ctx.lineTo(-20.0 * scale, 0)
		ctx.lineTo(5.0 * scale, 0)
